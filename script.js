...
let dinoAlive = setInterval(()=> {
   ...
   let dinoTopPosition = parseInt(window.getComputedStyle(dinoObject).getPropertyValue("top"))

   let dinoLeftPosition = parseInt(window.getComputedStyle(dinoObject).getPropertyValue("left"))

   let enemyLeftPosition = parseInt(window.getComputedStyle(enemyObject).getPropertyValue("left"))
...
if (enemyLeftPosition < 170 && enemyLeftPosition > 0 && dinoTopPosition >= 340 ) {
